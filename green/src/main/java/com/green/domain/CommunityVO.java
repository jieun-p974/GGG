...
public class CommunityVO {
	/*
	 * board_no 커뮤니티 번호 int(5) auto_increment(pk) id 회원 id varchar(20) b_content 글내용
	 * varchar(500) regist_date 작성일 date default current_timestamp() b_img1 커뮤니티이미지1
	 * varchar(100) b_img1_addr 커뮤니티이미지경로1 varchar(100) b_img2 커뮤니티이미지2 varchar(100)

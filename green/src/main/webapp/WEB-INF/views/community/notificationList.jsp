      ...
      <div class="container position-relative">
         ...
         <div class="row mt-5">
            <div
               ...
               <h2 class="text-black mb-0 mt-5 mb-3" style="font-size:2rem;text-align:left">📢공지 관리 페이지</h2>
               <a class="btn btn-warning btn-hover-secondery" id="add" href="notificationWrite.do">추가하기</a>
            </div>
         </div>

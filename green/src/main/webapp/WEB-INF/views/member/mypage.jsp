		...
		<div class="profile-page-center">
			...
			<section class="our-service position-relative overflow-hidden">
				<div class="container mt-5">
					<div class="info_heon">
						<div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 ps-xxl-0 ps-xl-0 ps-lg-3 ps-md-3 ps-sm-3 ps-3">
								...
								<div class="card-body pb-4">
									...
									<ul class="list-unstyled mb-0 pl-0">
										<c:forEach items="${challList}" var="c">
											...
											<span class="fs-7 text-black">${c.chal_name}</span></li>
										</c:forEach>
									</ul>
								</div>
								<div class="card-action text-center pb-xxl-5 pb-xl-5 pb-lg-5 pb-md-4 pb-sm-4 pb-4">

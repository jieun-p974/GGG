				...
				<div class="container mt-5">
					<div class="info_heon">
						...
						<div class="mt-3 info_btns">
							<div>
								<img alt="간편카드 등록" src="/resources/imgs/gapun_card.png"
									class="icons"> <a
									class="btn btn-warning btn-hover-secondery text-black"
									style="width: 215px"
									href="../member/cardRegist.do?userId=${userId}">간편결제 카드 등록</a>
							</div>
							<div>
								<img alt="간편계좌 등록" src="/resources/imgs/ganpun_acc.png"
									class="icons"> <a
									class="btn btn-warning btn-hover-secondery text-black"
									style="width: 215px"
							...
							<div>
								<img alt="회원 정보 수정" src="/resources/imgs/sujung.png"
									class="icons"> <a href="infoEdit.do"
									class="btn btn-warning btn-hover-secondery text-black"
									style="width: 215px" href="infoEdit.do"> 회원정보 수정 </a>
							</div>
							<div>
								<img alt="결제수단 관리" src="/resources/imgs/paymana.png"
									class="icons"> <a
									class="btn btn-warning btn-hover-secondery text-black"
									style="width: 215px" href="../pay/payment.do?userId=${userId}">
									결제 수단 관리 </a>
							</div>
						</div>
					</div>
						...
						<div class="row">
							<div
								...
								<h3 class="text-white mb-3">
									아직 대표캐릭터를 설정하지 않으셨군요? <br /> 더 많은 캐릭터들을 만나보세요.
								</h3>
							</div>
						</div>
							...
							<div
								...
								<div
									...
									<div class="card border-0 shadow h-100">
										<div class="card-body h-100 p-3">
											<div
												class="h-100 overflow-hidden rounded-circle position-relative d-flex align-items-center justify-content-center mx-auto text-center">
												<img class="img-grade"
													src="/resources/imgs/dogam/${myDogam.img1}">
											</div>
										</div>
									</div>
								</div>
									...
									<div class="card border-0 shadow h-100">
										<div class="card-body h-100 p-3">
											<div
												class="h-100 overflow-hidden rounded-circle position-relative d-flex align-items-center justify-content-center mx-auto text-center">
												<img class="img-grade"
													src="/resources/imgs/dogam/${myDogam.img2}">
											</div>
										</div>
									</div>
								</div>
									...
									<div class="card border-0 shadow h-100">
										<div class="card-body h-100 p-3">
											<div
												class="h-100 overflow-hidden rounded-circle position-relative d-flex align-items-center justify-content-center mx-auto text-center">
												<img class="img-grade"
													src="/resources/imgs/dogam/${myDogam.img3}">
											</div>
										</div>
									</div>
								</div>
								...
								<div class="animal_exp ms-3 mt-2">
									<div class="exps mb-2 d-flex justify-content-between">
										...
										<p class="exp_point">다음레벨까지(${myDogam.do_exp}/${myDogam.lev_max_point})</p>
									</div>

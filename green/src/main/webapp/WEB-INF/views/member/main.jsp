   ...
   <div class="container position-relative">
         ...
         <div class="row">
            <div
               ...
               <p class="text-white fs-3 mb-0 fw-bold"> 멸종 위기 동물에도 등급이 있다는 사실, 알고 계세요? </p>
            </div>
         </div>
         <div
            ...
            <div class="card border-0 shadow">
               <div class="card-body">
                  <div
                     ...
                     <p class="fw-500 fs-6 text-black"> 우리가 흔히 알고 있는 수많은 동물들이 멸종 위기에 처해있습니다.<br/>
         ...
         <div class="row d-flex flex-wrap justify-content-center step-row mb-5">
            <div
               class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 text-center">
               <div class="card border-0 shadow">
                  <div class="card-body">
                     <div
                        class="overflow-hidden rounded-circle position-relative d-flex align-items-center justify-content-center mx-auto text-center mb-5">
                     ...
                     <p class="mb-0 text-black fw-500 fs-5 mb-3">코알라</p>
                     <h4 class="fs-4">취약등급</h4>
                  </div>
               </div>
            </div>
            <div
               ...
               <div class="card border-0 shadow">
                  <div class="card-body">
                     ...
                     <p class="mb-0 text-black fw-500 fs-5 mb-3">황제펭귄</p>
                     <h4 class="fs-4">준위협등급</h4>
                  </div>
               </div>
            </div>
            <div
               ...
               <div class="card border-0 shadow">
                  <div class="card-body">
                     <div
                        class="overflow-hidden rounded-circle position-relative d-flex align-items-center justify-content-center mx-auto text-center mb-5">
                        <img class="img-grade" src="/resources/imgs/dogam/main_turtle.jpg"
                        onmouseover="this.src='/resources/imgs/dogam/40e1f773-908a-47a9-ad81-0d745d63f4f1_바다거북3.jpg'"
                        onmouseout="this.src='/resources/imgs/dogam/main_turtle.jpg'">
                     </div>
                     <p class="mb-0 text-black fw-500 fs-5 mb-3">바다거북</p>
                     <h4 class="fs-4">위기등급</h4>
                  </div>
               </div>
            </div>
      ...
      <div class="container position-relative">
         <div class="row">
            <div
               class="col-12 d-xxl-flex d-xl-flex d-lg-flex d-md-flex d-sm-block d-block align-items-center justify-content-xxl-between justify-content-xl-between justify-content-lg-between justify-content-md-between justify-content-sm-between justify-content-sm-center ">
               <p class="text-white fw-bold mb-0 fs-3 mt-5"> 귀여운 캐릭터를 직접 성장시키고, 도감을 모아보세요!</p>
            </div>
         </div>

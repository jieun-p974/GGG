			...
			<div class="row d-flex flex-wrap align-items-center">
				<div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
					<div class="position-relative left-hero-color">
						...
						<a href="../pay/challengePay.do?userId=${userId}" class="btn btn-warning btn-hover-secondery"> GGG와 함께 하기 </a>
					</div>
				</div>
				<div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
		...
		<div class="container">
			<div class="row">
				<div class="col-xxl-8 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
					<img src="/resources/imgs/our-service/our-service.svg" class="img-fluid">
				</div>
				<div class="col-xxl-4 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 ps-xxl-0 ps-xl-0 ps-lg-3 ps-md-3 ps-sm-3 ps-3">
					...
					<div class="d-flex align-items-center mt-3">
						<a class="btn btn-warning btn-hover-secondery" href="/challenge/challengeList.do" style="z-index: 0;">챌린지 구경하기</a>
					</div>
		...
		<div class="container position-relative">
			<div class="row">
				<div class="col-12 d-xxl-flex d-xl-flex d-lg-flex d-md-flex d-sm-block d-block align-items-center justify-content-xxl-between justify-content-xl-between justify-content-lg-between justify-content-md-between justify-content-sm-between justify-content-sm-center ">
					...
					<a href="/dogam/dogam.do" class="btn btn-warning btn-hover-secondery section-btn">당장 만나러가기</a>
				</div>
			</div>
			<div class="row d-flex flex-wrap justify-content-center step-row">
				<div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 text-center">
					<div class="card bg-transparent">
						<div class="card-body">
							<div class="overflow-hidden position-relative d-flex align-items-center justify-content-center mx-auto text-center">
								<img class="img-fluid" src="/resources/imgs/bear_shadow.png" alt="">
							</div>
		...
		<div class="container position-relative">
			<div class="row justify-content-center">
				<div class="col-xxl-6 col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12 text-center">
					<h2 class="pricing-head text-black mb-0 position-relative">도전권을 구매해 챌린지에 참여해보세요</h2>
				</div>
			</div>
			<div class="row justify-content-center price-plan">
				<div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
					<div class="card position-relative shadow border-0 h-100">
						<div class="card-body pt-5 p-3">
							<small class="fs-7 d-block text-warning text-center">3회 도전권</small>
							<h2 class="mb-4 text-center position-relative">
								<sub class="fs-2 text-black justify-content-center">3,000</sub>
							...
							<ul class=" mb-0 pl-0">
								...
								<small class="fs-9 text-black justify-content-center">결제일로 부터 30일간 적용됩니다.</small></li>
								<li class="d-flex align-items-start">
									<i class="ti ti-circle-check fs-4 pe-2"></i>
									<span class="fs-7 text-black">🌏 한달동안 챌린지에<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<span style="color: red">3번</span> 도전할 수 있습니다.
									</span>
								</li>
								<li class="d-flex align-items-start">
									<i class="ti ti-circle-check fs-4 pe-2"></i>
									<span class="fs-7 text-black">🌏 챌린지를 달성하시면 챌린지의<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;난이도x100만큼 포인트를<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;지급합니다. </span>
								</li>
							</ul>
						</div>
						<div class="card-action text-center pb-xxl-5 pb-xl-5 pb-lg-5 pb-md-4 pb-sm-4 pb-4">
							<a href="#" class="btn btn-warning btn-hover-secondery text-capitalize">도전권 결제</a>
						</div>
					</div>
				</div>
				<div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
					<div class="card position-relative shadow border-0 h-100">
						<div class="position-absolute badge bg-warning d-inline-block mx-auto"> Most Popular</div>
						<div class="card-body pt-5 p-3">
							<small class="fs-7 d-block text-warning text-center">7회 도전권</small>
							<h2 class="mb-4 text-center position-relative">
								<sub class="fs-2 text-black">5,000</sub>
								<sup class="fs-6 position-absolute">₩</sup>
							</h2>
							<p class="fs-7 text-center fw-500"></p>
							<ul class=" mb-0 pl-0">
								<li class="d-flex align-items-start justify-content-center">
									<small class="fs-9 text-black ">결제일로 부터 30일간 적용됩니다.</small>
								</li>
								<li class="d-flex align-items-start">
								<i class="ti ti-circle-check fs-4 pe-2"></i> 
								<span class="fs-7 text-black">🌏 한달동안 챌린지에<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: red">7번</span> 도전할 수 있습니다. </span>
								</li>
								<li class="d-flex align-items-start">
									<i class="ti ti-circle-check fs-4 pe-2"></i>
									<span class="fs-7 text-black">🌏 챌린지를 달성하시면 챌린지의<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;난이도x100만큼 포인트를 <br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;지급합니다. </span>
				...
				<div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
					<div class="card position-relative shadow border-0 h-100">
						<div class="card-body pt-5 p-3">
							<small class="fs-7 d-block text-warning text-center">무제한 도전권</small>
							<h2 class="mb-4 text-center position-relative">
								<sub class="fs-2 text-black">10,000</sub>
								<sup class="fs-6 position-absolute">₩</sup>
							</h2>
							<p class="fs-7 text-center fw-500"></p>
							<ul class=" mb-0 pl-0">
								...
								<li class="d-flex align-items-start">
									<i class="ti ti-circle-check fs-4 pe-2"></i>
									<span class="fs-7 text-black">🌏 한달동안 챌린지에 <br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: red">무제한</span>으로 도전할 수 있습니다. </span>
								</li>
								<li class="d-flex align-items-start">
									<i class="ti ti-circle-check fs-4 pe-2"></i>
									<span class="fs-7 text-black">🌏 챌린지를 달성하시면 챌린지의<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;난이도x100만큼 포인트를<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;지급합니다. </span>

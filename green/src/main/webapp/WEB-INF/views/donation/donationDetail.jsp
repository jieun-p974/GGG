	...
	<section class="service position-relative overflow-hidden">
		<div class="container position-relative">
			...
			<div class="row d-flex flex-wrap justify-content-center step-row">
				<div class="col-xxl-8 col-xl-8 col-lg-8 col-md-6 col-sm-6 col-12 text-center">
						...
						<div class="card-body">
							<div class="overflow-hidden position-relative d-flex align-items-center justify-content-center mx-auto text-center">
								<div class="pross">
									<div class="barUpper">
										<!-- 포인트 퍼센트 -->
										<fmt:formatNumber type="percent" value="${dona.don_point_sum/dona.don_goal}" var="percent" pattern="0%" />
										<p class="nowPer">${percent}</p>
										<!-- 디데이 계산 -->
										<fmt:parseNumber value="${now.time / (1000*60*60*24)}" integerOnly="true" var="nowfmtTime" scope="request" />
										<fmt:parseNumber value="${dona.don_end_date.time / (1000*60*60*24)}" integerOnly="true" var="dbDtParse" scope="request" />
									...
									<div class="barDown">
										<div class="donadate">${dona.don_start_date}~ ${dona.don_end_date}까지</div>

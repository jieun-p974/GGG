...
<link href="../../../resources/styles/checkChallenge.css"
		...
		<div class="my-challenge">
			<div class="challengeDetail">
				...
				<div class="detail">
					...
					<p class="gigan">기간: ${chall.chal_start_date} ~
						${chall.chal_end_date}</p>
					<p class="level" id="d_level">난이도:</p>
					<p class="content">${chall.chal_ex}</p>
				</div>
			</div>
			<div class="check_content">
				...
				<c:if test="${counting < chall.chal_check_su}">
					...
					<p class="comment">
						앞으로 <c:out value="${lefted}" />	번 더 인증하시면 챌린지가 완료됩니다!
					</p>

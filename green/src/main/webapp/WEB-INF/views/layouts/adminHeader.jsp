...
<body>
	<header class="main-header position-fixed w-100">
		...
		<div class="container">
			<div class="col-12 d-xxl-flex d-xl-flex d-lg-flex d-md-flex d-sm-block d-block  justify-content-xxl-end justify-content-xl-end justify-content-lg-end justify-content-md-end justify-content-sm-end justify-content-sm-center ">
				<h6 style="">${userId} ${userName} ${sessionTime} 접속</h6>
			</div>
			<nav class="navbar navbar-expand-xl py-0">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav me-auto p-0">
						...
						<li class="nav-item">
							<a class="nav-link text-capitalize" href="../dogam/dogamCheck.do">도감관리</a>
						</li>
						<li class="nav-item">
						...
						<li class="nav-item">
							<a class="nav-link text-capitalize" href="../community/notificationList.do">&nbsp&nbsp공지관리&nbsp&nbsp</a>
						</li>
						<li class="nav-item">
							<a class="nav-link text-capitalize" href="../member/adminMain.do">&nbsp&nbsp관리자페이지</a>
						</li>
					</ul>

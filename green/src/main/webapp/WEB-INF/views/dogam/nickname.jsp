   ...
   <div class="container position-relative mt-5" style="height:50px;"></div>
      <div class="container position-relative mt-5" style="width:70%;">
       <h2 class="mb-5">그동안 키워주셔서 감사해요💚</h2> 
         ...
         <div class="container position-relative mt-5" style="height:70px;"></div>
         <img class="mt-5" style='width:80%;' src="../resources/imgs/thankyou.png"> 
      
      <div class="d-flex justify-content-center ms-5" style="width:70%;">
      <a class="btn btn-white-back btn-hover-third me-5" href="../dogam/dogam.do">도감</a>
      <a class="btn btn-white-back btn-hover-third ms-5" href="../dogam/myDogam.do?id=${userId}">나의도감</a>
      </div>
      </div>

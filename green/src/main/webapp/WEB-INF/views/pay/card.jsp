...
<body>
	<div class="container">
		...
		<div class="card_info">
			...
			<div class="card_num">
				<input type="text" placeholder="0000" style="border: none" class="can1" /> - 
				<input type="text" placeholder="0000" style="border: none" class="can2" /> - 
				<input type="text" placeholder="0000" style="border: none" class="can3" /> - 
				<input type="text" placeholder="0000" style="border: none" class="can4" />
			</div>

...
<script type="text/javascript">
	...
	var pay = $('input[name=card]:checked').val();
</script>
		...
		<div class="main">
				...
				<div class="pay_method">
					...
					<%-- <div class="selecting">
						<div class="simple_account">
							<input type="radio" name="pay_meth_no" id="check_sa"
								checked="check" value="3" group="g1">간편 계좌
													<div class="accounts">
			<c:forEach items="${list}" var="payb">
					...
					<div class="accordion-item">
						<h2 class="accordion-header" id="headingOne">
							<button class="accordion-button" type="button" data-bs-toggle="collapse" 
								data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">간편계좌
							</button>
						</h2>
						<div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
							<div class="accordion-body">
								<div class="accounts">
									<c:forEach items="${list}" var="payb">
										<div class="debit-acc mb-2">
											<div class="d-flex flex-column h-90">
												...
												<div class="mt-2 fw-bold d-flex align-items-center justify-content-between">
													<p class="text-white fw-bold">${payb.acc_num}</p>
												</div>
											</div>
										</div>
									...
									<button class="plusC">
										<a href="../member/accountRegist.do?userId=${userId}">간편계좌 추가 등록</a>
									</button>
								</div>
							</div>
						</div>
					...
					<div class="accordion-item">
						<h2 class="accordion-header" id="headingTwo">
							<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo"
								aria-expanded="false" aria-controls="collapseTwo">간편카드
							</button>
						</h2>
						<div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
							<div class="cards">
								...
								<button class="plusC">
									<a href="../member/cardRegist.do?userId=${userId}">간편카드 추가 등록</a>
								</button>
							</div>
						</div>
					</div>
				...
				<%-- <div class="simple_card">
							<input type="radio" name="pay_meth_no" id="check_sc" group="g1">간편
							카드
							<div class="cards">
								<c:forEach items="${list2}" var="payc">
									<div class="debit-card mb-2">
										<div class="d-flex flex-column h-90">
											<label class="d-block">
												<div class="d-flex position-relative mb-5">
													...
													<div class="input">
														<input type="radio" name="card" id="check1"> <input
															type="hidden" name="pay_meth_no" value="4">
													</div>
												</div>
											</label>
											<div
								...
								<button class="plusC">
									<a href="../member/cardRegist.do?userId=${userId}">간편카드 추가
										등록</a>
								</button>
							</div> --%>
		
				<div class="accout_pay">
					<input type="radio" name="pay_meth_no" id="check_a">일반 계좌 
					<input type="hidden" name="pay_meth_no" value="1">
				</div>
				<div class="card_pay">
					<input type="radio" name="pay_meth_no" id="check_c">일반 카드
					<input type="hidden" name="pay_meth_no" value="2">
				</div>

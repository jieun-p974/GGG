									...
									<div class="accounts">
										<div class="method">
											<c:forEach items="${list}" var="payb">
												<a class="">
												<div class="payMethod row m-0 col-11 mb-2 text-start" style="height:150px;">
								...
								<div class="accordion-body">
									...
									<div class="method">
										<c:forEach items="${list2}" var="payc">
											<a class="">
											<div class="payMethod row m-0 col-11" style="height:200px;">
												<p hidden="hidden">${payc.mem_card_no}</p>
												<p class="mt-2 mb-5 text-white fw-bold col-12 text-start">${payc.card_company}</p>
												<div class="d-flex justify-content-between">
